...
// 2. Add an Email Service (connect your Gmail → contactbutterstack@gmail.com)
...
const EMAILJS_SERVICE_ID  = 'service_tkz36io'   // e.g. 'service_xxxxxxx'
const EMAILJS_TEMPLATE_ID = 'template_jl0xqbq'  // e.g. 'template_xxxxxxx'
const EMAILJS_PUBLIC_KEY  = 's-gjVzpKVUMzyph7s'   // e.g. 'abc123XYZxxxxxxxx'
// ────────────────────────────────────────────────────────────────
        ...
        <div className="contact-grid">
          ...
          <div className="contact-info anim-card" data-delay="0">
            ...
            <div className="contact-socials">
              {[['fab fa-twitter','https://x.com'],['fab fa-instagram','https://www.instagram.com'],['fab fa-linkedin-in','https://www.linkedin.com/company/addon-shareware-pvt-ltd']].map(([icon, href]) => (
